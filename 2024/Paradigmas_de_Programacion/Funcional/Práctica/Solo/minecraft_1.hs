...
mayorPuntajeOrdenNormal :: [Material] -> Personaje -> Bool
mayorPuntajeOrdenNormal recetas personaje = puntaje (crafteosSucesivos recetas personaje) > puntaje (crafteosSucesivos (reverse recetas) personaje)
